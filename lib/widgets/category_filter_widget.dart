  ...
  Align createCategoryFilterWidget(
    ...
    return Align(
      ...
      child: Wrap(
        ...
        children: _isMyPosts
            ? _myPostsProviders.categoryFilterList.map(
                (element) {
                  bool _isSelectedCategoryFilter = _myPostsProviders
                    ...
                    onTap: () {
                      if (!_isSelectedCategoryFilter) {
                        if (_myPostsProviders
                                .selectedCategoryFilterList.length <
                            10) {
            ...
            : _myVotedProviders.categoryFilterList.map(
                (element) {
                  bool _isSelectedCategoryFilter = _myVotedProviders
                      .selectedCategoryFilterList
                      .contains(element);
                  return GestureDetector(
                    child: Chip(
